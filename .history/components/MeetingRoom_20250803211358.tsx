    ...
    const CallLayout = () => {
      ...
      return (
        <section className="relative h-screen w-full overflow-hidden pt-4 text-white">
            ...
            <div className="fixed bottom-0 left-0 right-0 flex items-center justify-center gap-1 sm:gap-1 lg:gap-3 p-2 sm:p-4 bg-black bg-opacity-50 backdrop-blur-sm">
