...
const NavBar = () => {
  const pathname = usePathname();
    ...
    return (
        <>
          <nav className="flex justify-between items-center fixed z-50 w-full h-20 sm:h-28 bg-gray-200 px-4 sm:px-10 gap-2 sm:gap-4 shadow-2xl">
              {/* Logo */}
                  ...
                  {navLinks.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        key={item.label}
                        className={
                          cn('flex gap-1 sm:gap-4 items-center p-2  hover:scale-150 duration-300 ',
